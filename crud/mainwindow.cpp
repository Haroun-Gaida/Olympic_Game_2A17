...
void MainWindow::on_pushButton_clicked()
{
    ...
    QFileDialog dialog(this);
            dialog.setNameFilter(tr("Images (*.png *.xpm *.jpg)"));
            dialog.setViewMode(QFileDialog::Detail);
            QString fileName =QFileDialog::getOpenFileName(this, tr("Open Images"), "C:/Users/Haroun-Gaida/OneDrive/Desktop/crud/crud", tr("Image Files (*.png *.jpg *.bmp)"));
            if (!fileName.isEmpty())
            {
                QImage img(fileName);
...
{int ID=ui->le_supp->text().toInt();
    ...
    foreach(QLineEdit* le, findChildren<QLineEdit*>()) {
                 le->clear();}
            QFile file("C:/Users/Haroun-Gaida/OneDrive/Desktop/crud/crud/Historique/historique.txt");
...
void MainWindow::on_PDF_clicked()
{
    QSqlDatabase db;
                ...
                QSqlQuery qry;
                 ...
                 out <<  "<html>\n"
                         "<img src='C:/Users/Haroun-Gaida/OneDrive/Desktop/crud/crud/' height='120' width='120'/>"
                     "<head>\n"
